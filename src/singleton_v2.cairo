...
mod SingletonV2 {
    ...
    impl InternalFunctions of InternalFunctionsTrait {
        ...
        fn settle_position(
            ...
            if collateral_delta < Zero::zero() {
                let asset_config = self.asset_config(pool_id, collateral_asset);
            ...
            if debt_delta < Zero::zero() {
                let asset_config = self.asset_config(pool_id, debt_asset);
    ...
    impl SingletonV2Impl of ISingletonV2<ContractState> {
        ...
        fn rate_accumulator(self: @ContractState, pool_id: felt252, asset: ContractAddress) -> u256 {
            let asset_config = self.asset_config(pool_id, asset);
        ...
        fn context(
            ...
            let collateral_asset_config = self.asset_config(pool_id, collateral_asset);
            let debt_asset_config = self.asset_config(pool_id, debt_asset);
