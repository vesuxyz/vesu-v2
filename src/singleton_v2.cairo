...
use vesu::data_model::{
    Amount, AssetConfig, AssetParams, AssetPrice, Context, LTVConfig, LiquidatePositionParams,
    LiquidationConfig, ModifyPositionParams, Pair, Position, PragmaOracleParams, ShutdownConfig, ShutdownMode,
    ShutdownStatus, UpdatePositionResponse,
};
...
mod SingletonV2 {
    ...
    use vesu::data_model::{
        Amount, AmountDenomination, AssetConfig, AssetParams, AssetPrice, Context, LTVConfig,
        LiquidatePositionParams, LiquidationConfig, ModifyPositionParams, Pair, Position, PragmaOracleParams,
        ShutdownConfig, ShutdownMode, ShutdownState, ShutdownStatus, UpdatePositionResponse, assert_asset_config,
