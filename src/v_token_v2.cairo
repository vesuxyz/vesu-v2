...
pub mod VTokenV2 {
    ...
    pub fn calculate_withdrawable_assets(asset_config: AssetConfig, total_debt: u256) -> u256 {
        ...
        let utilization = u256_mul_div(total_debt, SCALE, asset_config.reserve + total_debt, Rounding::Ceil);
        ...
        (asset_config.reserve + total_debt)
            - u256_mul_div(
                total_debt,
                (u256_mul_div(SCALE, scale, asset_config.max_utilization, Rounding::Ceil)),
                scale,
                Rounding::Ceil,
            )
    }
    ...
    impl VTokenV2 of IVTokenV2<ContractState> {
        ...
        /// Returns the address of the vTokenV1 contract
        /// # Returns
        /// * address of the vTokenV1 contract
        fn v_token_v1(self: @ContractState) -> ContractAddress {
            self.v_token_v1.read()
        }

        /// Migrates v1 vToken to v2 vToken
        fn migrate_v_token(ref self: ContractState) {
