...
mod TestDefaultPOV2 {
    ...
    fn test_set_asset_parameter_not_owner() {
        ...
        create_pool(pool, config, users.curator, users.curator, Option::None);
    ...
    fn test_set_oracle_parameter() {
        ...
        start_cheat_caller_address(pool.contract_address, users.curator);
        pool.set_oracle_parameter(config.collateral_asset.contract_address, 'timeout', 5_u64.into());
        stop_cheat_caller_address(pool.contract_address);

        let oracle_config = pool.oracle_config(config.collateral_asset.contract_address);
        assert(oracle_config.timeout == 5_u64, 'timeout not set');

        start_cheat_caller_address(pool.contract_address, users.curator);
        pool.set_oracle_parameter(config.collateral_asset.contract_address, 'number_of_sources', 11_u64.into());
        stop_cheat_caller_address(pool.contract_address);
        ...
        start_cheat_caller_address(pool.contract_address, users.curator);
        pool.set_oracle_parameter(config.collateral_asset.contract_address, 'start_time_offset', 10_u64.into());
        stop_cheat_caller_address(pool.contract_address);
        ...
        start_cheat_caller_address(pool.contract_address, users.curator);
        pool.set_oracle_parameter(config.collateral_asset.contract_address, 'time_window', 10_u64.into());
        stop_cheat_caller_address(pool.contract_address);
        ...
        start_cheat_caller_address(pool.contract_address, users.curator);
        pool.set_oracle_parameter(config.collateral_asset.contract_address, 'aggregation_mode', 'Mean'.into());
        stop_cheat_caller_address(pool.contract_address);
        ...
        start_cheat_caller_address(pool.contract_address, users.curator);
        pool.set_oracle_parameter(config.collateral_asset.contract_address, 'pragma_key', '123'.into());
        stop_cheat_caller_address(pool.contract_address);
    ...
    fn test_set_oracle_parameter_invalid_oracle_parameter() {
        ...
        start_cheat_caller_address(pool.contract_address, users.curator);
        pool.set_oracle_parameter(config.collateral_asset.contract_address, 'a', 5_u64.into());
        stop_cheat_caller_address(pool.contract_address);
    }
    ...
    fn test_set_oracle_parameter_oracle_config_not_set() {
        ...
        start_cheat_caller_address(pool.contract_address, users.curator);
        pool.set_oracle_parameter(Zero::zero(), 'timeout', 5_u64.into());
        stop_cheat_caller_address(pool.contract_address);
    }
    ...
    fn test_set_oracle_parameter_time_window_greater_than_start_time_offset() {
        ...
        start_cheat_caller_address(pool.contract_address, users.curator);
        pool.set_oracle_parameter(config.collateral_asset.contract_address, 'time_window', 1_u64.into());
        stop_cheat_caller_address(pool.contract_address);
    }
