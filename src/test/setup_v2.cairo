...
pub fn setup_env(
    ...
    singleton.set_fee_config(FeeConfig { fee_recipient: users.extension_owner });
...
pub fn setup_pool(
    ...
    create_pool(singleton, config, users.owner, users.extension_owner, interest_rate_config);
