...
#[starknet::interface]
pub trait IStarkgateERC20<TContractState> {
...
mod TestForking {
    ...
    use vesu::extension::components::position_hooks::{LiquidationData, ShutdownMode};
    ...
    fn setup() -> SetupParams {
        ...
        let migrator = contract_address_const::<'migrator'>();
        let owner = get_contract_address();
        let singleton_v1 = deploy_contract("MockSingleton");

        let singleton_v2_class_hash = 0x053954317aa06c4ba84c54245e85d1a152a7b4a0f4463e5da393cb8e2d31b21e;
        let (singleton_v2_address, _) = (deploy_syscall(
        ...
        let singleton = ISingletonV2Dispatcher { contract_address: singleton_v2_address };

        let v_token_class_hash = 0x05c64c6cb528bdbffe4187ba3385ff3843b43e8375ad4c3ddd6c28c1d5193576;
        let v_token_v2_class_hash = 0x035c58475afe0f44fa5267ffee18facd535ae5bb64085035369d07ce2b3afb4d;
        let extension_utils_class_hash = 0x0507ce25ded7b48a554aefc1db89d191123bea56f6d5269824f572164fad5e2e;

        let extension_class_hash = 0x075dc76272d8af04bb93a363ff0706aa1b5d876d9fb877532c5d4ad7d5c49a6e;
        let (extension_address, _) = (deploy_syscall(
            extension_class_hash.try_into().unwrap(),
            0,
            array![
        ...
        let extension = IDefaultExtensionPOV2Dispatcher { contract_address: extension_address };
