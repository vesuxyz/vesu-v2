...
mod TestUpgrade {
    ...
    use vesu::{
        ...
        test::{test_forking::{IStarkgateERC20Dispatcher, IStarkgateERC20DispatcherTrait}, setup_v2::{deploy_with_args}},
        vendor::{
            ...
            .len() {
                ...
                while j < assets_copy
                    .len() {
                        ...
                        let v_token_for_collateral_asset = extension
                        ...
                        assert!(
                            v_token_for_collateral_asset == extension
                                .v_token_for_collateral_asset(pool_id, collateral_asset)
                        );
                        assert!(
                        ...
                        while k < assets_copy
                            .len() {
                                ...
                                let liquidation_config = extension
                                    .liquidation_config(pool_id, collateral_asset, debt_asset);
                                let shutdown_ltv_config = extension
                                    .shutdown_ltv_config(pool_id, collateral_asset, debt_asset);
                                ...
                                assert!(
                                    liquidation_config == extension
                                        .liquidation_config(pool_id, collateral_asset, debt_asset)
                                );
                                assert!(
                                    shutdown_ltv_config == extension
                                        .shutdown_ltv_config(pool_id, collateral_asset, debt_asset)
                                );
