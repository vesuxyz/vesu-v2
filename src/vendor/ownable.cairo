...
// OpenZeppelin Contracts for Cairo v1.0.0 (access/ownable/interface.cairo)
...
pub mod OwnableComponent {
    ...
    use super::{IOwnableTwoStep, IOwnableTwoStepCamelOnly, IOwnable, IOwnableCamelOnly, OwnableABI, OwnableTwoStepABI};
    ...
    impl Ownable<TContractState, +HasComponent<TContractState>,> of IOwnable<ComponentState<TContractState>> {
        ...
        fn transfer_ownership(ref self: ComponentState<TContractState>, new_owner: ContractAddress,) {
            assert(!Zero::is_zero(@new_owner), Errors::ZERO_ADDRESS_OWNER);
    ...
    > of IOwnableTwoStep<ComponentState<TContractState>> {
        /// Returns the address of the current owner.
        fn owner(self: @ComponentState<TContractState>) -> ContractAddress {
            self.Ownable_owner.read()
        }
    ...
    impl OwnableCamelOnly<
        TContractState, +HasComponent<TContractState>,
    > of IOwnableCamelOnly<ComponentState<TContractState>> {
    ...
    impl OwnableTwoStepCamelOnly<
        TContractState, +HasComponent<TContractState>,
    > of IOwnableTwoStepCamelOnly<ComponentState<TContractState>> {
    ...
    > of OwnableABI<ComponentState<TContractState>> {
        // IOwnable
        fn owner(self: @ComponentState<TContractState>) -> ContractAddress {
            Ownable::owner(self)
        }
    ...
    impl OwnableTwoStepMixin<
        TContractState, +HasComponent<TContractState>, +Drop<TContractState>,
    > of OwnableTwoStepABI<ComponentState<TContractState>> {
        // IOwnableTwoStep
        fn owner(self: @ComponentState<TContractState>) -> ContractAddress {
    ...
    pub impl InternalImpl<TContractState, +HasComponent<TContractState>,> of InternalTrait<TContractState> {
        ...
        fn initializer(ref self: ComponentState<TContractState>, owner: ContractAddress) {
            assert(!Zero::is_zero(@owner), Errors::ZERO_ADDRESS_OWNER);
