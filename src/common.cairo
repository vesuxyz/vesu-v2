...
pub fn calculate_fee_shares(asset_config: AssetConfig, new_rate_accumulator: u256) -> u256 {
    ...
    let accrued_interest = calculate_debt(total_nominal_debt, rate_accumulator_delta, scale, true);
...
pub fn deconstruct_collateral_amount(collateral: Amount, asset_config: AssetConfig) -> (i257, i257) {
...
pub fn deconstruct_debt_amount(debt: Amount, rate_accumulator: u256, asset_scale: u256) -> (i257, i257) {
...
pub fn apply_position_update_to_context(
    ...
    let (mut collateral_delta, mut collateral_shares_delta) = deconstruct_collateral_amount(
        collateral, context.collateral_asset_config,
    );
