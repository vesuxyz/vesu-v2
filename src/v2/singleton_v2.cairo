...
use vesu::{
    ...
    singleton::{IFlashloanReceiver, IFlashloanReceiverDispatcher, IFlashloanReceiverDispatcherTrait},
};
...
mod SingletonV2 {
    ...
    impl InternalFunctions of InternalFunctionsTrait {
        ...
        fn _migrate_position(
            ...
            let (positionV1, _, _) = ISingletonDispatcher { contract_address: self.singleton_v1.read() }
        ...
        fn context_unsafe(
            ...
            let mut context = Context {
                ...
                position: if !_is_v1_pool(pool_id)
                    ...
                    let (position, _, _) = ISingletonDispatcher { contract_address: self.singleton_v1.read() }
