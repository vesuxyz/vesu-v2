...
import DEPLOYMENT from "vesu_changelog/deployments/deployment_sn_main_v2.json" with { type: "json" };
...
export const poolConfig: PoolConfig = {
  ...
  v_token_params: CONFIG.asset_parameters.map((asset: any) => ({
    ...
    debt_asset: CONFIG.asset_parameters.find((_asset: any) => _asset.asset_name !== asset.asset_name)!.token.address,
  })),
